...
def EfficientNet(width_coefficient,
    ...
    if weights == 'imagenet':
        ...
        if not spatial_dropout:
            ...
            initial_model = EfficientNetB32(input_tensor=input_tensor, default_resolution=img_input.shape[1], weights='imagenet',
                                            include_top=False, input_shape=(img_input.shape[1], img_input.shape[1], 3))
